...
var streamampConfig = {
    ...
    adUnits: [{
        ...
        mediaTypes: {
            banner: {
                sizes: [[728, 90], [320, 50], [1, 1], [970, 250], [970, 90], [468, 60]]
            }
        },
        isSticky: false,
        safeFrame: false,
        ...
        bids: [{
            ...
            bidder: 'openx',
            labelAny: ['971-9999', '721-970', '469-720', '0-468'],
            params: {
                unit: '540279392',
        ...
        mediaTypes: {
            banner: {
                sizes: [[728, 90], [320, 50], [468, 60], [320, 100]]
            }
        },
        isSticky: false,
        safeFrame: false,
        ...
        breakpoints: {
            '971-9999': [[728, 90], [468, 60]],
            '721-970': [[728, 90], [468, 60]],
            '469-720': [[320, 50], [468, 60], [320, 100]],
            '0-468': [[320, 50], [320, 100]]
        }
    }, {
        code: 'Unit3',
        ...
        breakpoints: {
            '971-9999': [[160, 600], [120, 600]],
            '721-970': [[160, 600], [120, 600]]
        }
    }, {
        code: 'Unit6',
        ...
        mediaTypes: {
            banner: {
                sizes: [[970, 250], [728, 90], [320, 50], [468, 60], [970, 90], [320, 100]]
            }
        },
        isSticky: false,
        safeFrame: false,
        ...
        breakpoints: {
            '971-9999': [[970, 250], [728, 90], [468, 60], [970, 90]],
            '721-970': [[970, 250], [728, 90], [468, 60], [970, 90]],
            '469-720': [[320, 50], [468, 60], [320, 100]],
            '0-468': [[320, 50], [320, 100]]
        }
    }, {
        ...
        breakpoints: {
            '971-9999': [[300, 250]],
            '721-970': [[300, 250]],
            '469-720': [[300, 250], [320, 50], [320, 100]],
            '0-468': [[300, 250], [320, 50], [320, 100]]
        }
    }, {
        code: 'Unit9',
    ...
    breakpoints: [{
        ...
        minWidth: 971,
        maxWidth: 9999,
        sizesSupported: [[728, 90], [160, 600], [970, 250], [300, 250], [1, 1]]
    }, {
        label: '721-970',
        minWidth: 721,
        maxWidth: 970,
...
window.streamamp = {
    ...
    initialize: function(boolean) {
        ...
        if (boolean) {
                    window.__cmp('getConsentData', null, function (vendorList) {
