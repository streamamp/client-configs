var streamampConfig = {
    ...
    adUnits: [
            ...
            bids: [
                {
                    ...
                    params: {
                        zoneId: 1382492,
                        publisherSubId: 'TZ_MPU1_300x600'
                    }
                },
                {
                    bidder: 'criteo',
                    ...
                    params: {
                        zoneId: 1382491,
                        publisherSubId: 'TZ_MPU1_300x250'
                    }
                },
                {
                    bidder: 'emx_digital',
            ...
            bids: [
                {
                    ...
                    params: {
                        zoneId: 1382492,
                        publisherSubId: 'TZ_MPU2_300x600'
                    }
                },
                {
                    bidder: 'emx_digital',
            ...
            bids: [
                {
                    ...
                    params: {
                        zoneId: 1382491,
                        publisherSubId: 'TZ_MPU3_300x250'
                    }
                },
                {
                    bidder: 'emx_digital',
        ...
        {
            code: 'TZ_Brand_Sponsorship',
            path: '/4394518/TZ_Brand_Sponsorship',
            mediaTypes: {
                banner: {
                    sizes: []
                }
        ...
        {
            code: 'TZ_aa_sponsorship',
            path: '/4394518/TZ_aa_sponsorship',
            mediaTypes: {
                banner: {
                    sizes: []
                }
            ...
            bids: [
                {
                    ...
                    params: {
                        zoneId: 1382490,
                        publisherSubId: 'TZ_Sticky_320x50'
                    }
                },
                {
                    bidder: 'emx_digital',
            ...
            bids: [
                {
                    ...
                    params: {
                        zoneId: 1382488,
                        publisherSubId: 'TZ_Mid2_970x250'
                    }
                },
                {
                    bidder: 'criteo',
