var streamampConfig = {
    ...
    adUnits: [{
        ...
        mediaTypes: {
            banner: {
                sizes: [[320, 50], [300, 250], [970, 250], [728, 90], [320, 100]]
            }
        },
        isSticky: false,
        safeFrame: true,
        bids: [{
            bidder: 'criteo',
            labelAny: ['1000 - 9999', '769 - 999', '469 - 768', '0 - 468'],
            params: {
                zoneId: 1382491,
        ...
        mediaTypes: {
            banner: {
                sizes: [[728, 90], [320, 50], [300, 250], [970, 250], [320, 100]]
            }
        },
        isSticky: false,
        safeFrame: true,
    ...
    cmp: {
        ...
        styles: {
            ...
            customCSS: '.qc-cmp-bounty-p {' +
                ...
                '}' +
                '.qc-cmp-purposes-header .qc-cmp-button {' +
    ...
    breakpoints: [{
        ...
        minWidth: 1000,
        maxWidth: 9999,
        sizesSupported: [[970, 250], [728, 90], [300, 250], [160, 600], [1, 1]]
    }, {
        label: '769 - 999',
        minWidth: 769,
        maxWidth: 999,
        sizesSupported: [[728, 90], [300, 250], [970, 250], [160, 600], [1, 1]]
    }, {
        label: '469 - 768',
        minWidth: 469,
        maxWidth: 768,
